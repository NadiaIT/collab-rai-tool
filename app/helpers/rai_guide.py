...
direct_stakeholder_def = "<b>Direct stakeholders</b> include people who interact with the system directly. They can be system owners, primary users, secondary users, decision subjects or data subjects and malicious actors."
indirect_stakeholder_def = "<b>Indirect stakeholders</b> are affected by the system but, unlike direct stakeholders, do not engage with the system itself. Indirect stakeholders can include bystanders, people responsible for decision subjects or data subjects (such as parents), society at large, or communities who may be affected by the system but don't use it."
...
surprising_def = "Surprising -- Low level of surprisingness represent scenarios that humans can easily think of given the context based on common examples and media stories. High level of surprisingness represent scenarios that are not well represented in common public discourse. Consider in the prespective of people who have seen standard media discourse / standard examples but are not expert. "
concrete_def = "Concrete -- Low level of concreteness means that it is providing generic description of a problem. High level of concretness means that is is talking about a story about a specific named individual or entity."
relevant_def = "Relevant -- High level of relevance means that the scenario is relveant to the description of the context and represent a realistic & meaningful story. Low level of relevance means that the scenario is making unrealistic assumptions, is irrelevant to the provided context, or not making sense in general."
